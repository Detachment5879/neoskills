...
def slugify(text: str) -> str:
    ...
    # Replace Chinese/etc with transliteration placeholder
...
def update_index(title: str, filepath: str, tags: list, content_type: str):
...
"""
    ...
    # Add entity section if entities exist
    if entity_links:
        body += f"""## 🔗 关联实体
...
def get_stats():
    ...
    # Exclude hidden files like .index.md for some stats
